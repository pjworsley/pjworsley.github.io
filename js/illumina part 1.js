...
function phaseSelect (droppersArray, droppersCount, dd01, dd02, dd03, dd04, dd05) {
  var phase1 = ["dragger01", "dragger02", "dragger03", "dragger04", "dragger05", 0, 0, 0, 0, 0, 0, 0];
  console.log(droppersArray);
  if (equalsArray(phase1, droppersArray)) {
    phaseOne() } else {}

  var phase2 = ["dragger01", "dragger02", "dragger03", "dragger04", "dragger05", "dragger06", "dragger07", "dragger08", "dragger09", "dragger10", "dragger11", "dragger12"];
...
function makeConnections () {
  ...
  $('#anchor8, #anchor9').connections({
  });
  $('#anchor9, #anchor10').connections({
  });
  $('#anchor10, #anchor12').connections({
  });
  $('#anchor11, #anchor12').connections({
  });
  $('#anchor12, #anchor14').connections({
  });
  $('#anchor13, #anchor12').connections({
  });
