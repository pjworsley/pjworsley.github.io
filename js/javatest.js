...
function phaseSelect (droppersArray, droppersCount, dd01, dd02, dd03, dd04, dd05) {
       console.log(dd02);
  var phase1 = ["dragger01", "dragger02", "dragger03", "dragger04", "dragger05", "dragger06", 0, 0, 0, 0, 0, 0, 0, 0, 0];
  if (equalsArray(phase1, droppersArray)) {
    phaseOne() } else {}

  var phase2 = ["dragger01", "dragger02", "dragger03", "dragger04", "dragger05", "dragger06", 0, 0, 0, 0, 0, 0, 0, 0, 0];
  if ((equalsArray(phase2, droppersArray)) && (dd01 == true)) {
    phaseTwo() } else {}

  var phase3 = ["dragger01", "dragger02", "dragger03", "dragger04", "dragger05", "dragger06", "dragger07", "dragger08", 0, 0, 0, 0, 0, 0, 0];
  if ((equalsArray(phase3, droppersArray))) {
    phaseThree() } else {}

  var phase4 = ["dragger01", "dragger02", "dragger03", "dragger04", "dragger05", "dragger06", "dragger07", "dragger08", "dragger09", "dragger10", "dragger11", 0, 0, 0, 0];
  var phase4b = ["dragger01", "dragger02", "dragger03", "dragger04", "dragger05", "dragger06", "dragger07", "dragger08", "dragger10", "dragger09", "dragger11", 0, 0, 0, 0];
  if ((equalsArray(phase4, droppersArray)) && (dd02 == true)) {
    phaseFour() } else {}
  if ((equalsArray(phase4b, droppersArray)) && (dd02 == true)) {
    phaseFour() } else {}

  var phase5 = ["dragger01", "dragger02", "dragger03", "dragger04", "dragger05", "dragger06", "dragger07", "dragger08", "dragger09", "dragger10", "dragger11", "dragger12", "dragger13", 0, 0];
  if ((equalsArray(phase5, droppersArray)) && (dd03 == true)) {
    phaseFive() } else {}
  var phase5b = ["dragger01", "dragger02", "dragger03", "dragger04", "dragger05", "dragger06", "dragger07", "dragger08", "dragger10", "dragger09", "dragger11", "dragger12", "dragger13", 0, 0];
  if ((equalsArray(phase5b, droppersArray)) && (dd03 == true)) {
    phaseFive() } else {}

  var phase6 = ["dragger01", "dragger02", "dragger03", "dragger04", "dragger05", "dragger06", "dragger07", "dragger08", "dragger09", "dragger10", "dragger11", "dragger12", "dragger13", "dragger14", "dragger15"];
  if ((equalsArray(phase6, droppersArray))) {
    phaseSix() } else {}
  var phase6b = ["dragger01", "dragger02", "dragger03", "dragger04", "dragger05", "dragger06", "dragger07", "dragger08", "dragger10", "dragger09", "dragger11", "dragger12", "dragger13", "dragger14", "dragger15"];
  if ((equalsArray(phase6b, droppersArray))) {
    phaseSix() } else {}
...
function phaseFour () {
  $('.phaseFour').fadeIn(200);
  $('.phaseFourH').fadeIn(200);
  $('.phaseThreeH').fadeOut(50);
  $('.phaseThreeD').draggable();
  $('.phaseThreeD').draggable('disable');
  makeConnections ();
};

function phaseFive () {
  $('.phaseFive').fadeIn(200);
  $('.phaseFiveH').fadeIn(200);
  $('.phaseFourH').fadeOut(50);
  $('.phaseFourD').draggable();
  $('.phaseFourD').draggable('disable');
  makeConnections ();
};

function phaseSix () {
  $('.phaseSix').fadeIn(200);
  $('.phaseSixH').fadeIn(200);
  $('.phaseFiveH').fadeOut(50);
  $('.phaseFiveD').draggable();
  $('.phaseFiveD').draggable('disable');
  makeConnections ();
};
...
function makeConnections () {
  $('#anchor1, #anchor3').connections({
  });
  $('#anchor2, #anchor3').connections({
  });
  $('#anchor3, #anchor4').connections({
  });
  $('#anchor4, #anchor5').connections({
    'class': 'tester'
  });
  $('#anchor5, #anchor6').connections({
  });
  $('#anchor6, #anchor7').connections({
  });
  $('#anchor7, #anchor8').connections({
  });
  $('#anchor8, #anchor10').connections({
  });
  $('#anchor9, #anchor11').connections({
  });
  $('#anchor10, #anchor12').connections({
  });
  $('#anchor11, #anchor12').connections({
  });
  $('#anchor12, #anchor13').connections({
  });
  $('#anchor13, #anchor13b').connections({
  });
  $('#anchor13b, #anchor14').connections({
  });
  $('#anchor14, #anchor15').connections({
  });
  $('#anchor15, #anchor16').connections({
  });
  $('#anchor16, #anchor17').connections({
  });
  $('#anchor17, #anchor18').connections({
  });
  $('#anchor18, #anchor19').connections({
  });
  $('#anchor19, #anchor20').connections({
  });
  $('#anchor20, #anchor21').connections({
  });
  $('#anchor21, #anchor22').connections({
  });
  $('#anchor22, #anchor23').connections({
  });
  $('#anchor23, #anchor25').connections({
  });
  $('#anchor22, #anchor25').connections({
  });
  $('#anchor25, #anchor26').connections({
  });
  $('#anchor26, #anchor27').connections({
  });
  $('#anchor27, #anchor28').connections({
  });
  $('#anchor28b, #anchor28').connections({
  });
  $('#anchor28, #anchor29').connections({
  });
  $('#anchor29, #anchor30').connections({
  });
  $('#anchor30, #anchor31').connections({
  });
  $('#anchor31, #anchor32').connections({
  });
  $('#anchor32, #anchor33').connections({
  });
  $('#anchor33, #anchor34').connections({
  });
  $('#anchor34, #anchor35').connections({
  });
  $('#anchor35, #anchor36').connections({
  });
  $('#anchor36, #anchor37').connections({
  });
  $('#anchor37, #anchor38').connections({
  });
  $('#anchor38, #anchor39').connections({
  });
};
...
makeConnections ()
 ...
 $('.dna-dropper').droppable({
     drop: function (event, ui) {
       ...
       if(($(this).attr("id") == "dna-dropper3") && ($(ui.draggable).attr("id") == "d4-dna-dragger3") && (posOneLeft - posTwoLeft) > 200 && (posOneLeft - posTwoLeft) < 250) {
       dd03 = true;
       } else {
       dd03 = false;
